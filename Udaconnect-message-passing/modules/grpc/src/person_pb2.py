...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0cperson.proto\"S\n\rPersonMessage\x12\x12\n\nfirst_name\x18\x01 \x01(\t\x12\x11\n\tlast_name\x18\x02 \x01(\t\x12\n\n\x02id\x18\x03 \x01(\x05\x12\x0f\n\x07\x63ompany\x18\x04 \x01(\t2@\n\rPersonService\x12/\n\x0bstorePerson\x12\x0e.PersonMessage\x1a\x0e.PersonMessage\"\x00\x62\x06proto3'
)
...
_PERSONMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='PersonMessage.id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='company', full_name='PersonMessage.company', index=3,
...
_PERSONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='storePerson',
    full_name='PersonService.storePerson',
    index=0,
